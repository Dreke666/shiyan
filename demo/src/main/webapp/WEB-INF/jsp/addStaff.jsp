    ...
    <div class="row">
        ...
        <div class="col-sm-10" id="right">
            <ol class="breadcrumb">
                ...
                <li class="active">添加员工
                </li>
            </ol>


            <div class="container">
                <center><h3>添加信息页面</h3></center>
                <form action="${pageContext.request.contextPath}/addStaff" method="post" id="form1" onsubmit="return check()">
                    <div class="form-group">
                        <label for="staffcode">工号：</label>
                        <input type="text" class="form-control" id="staffcode" name="staffcode" placeholder="请输入工号">
                    </div>
                    <div class="form-group">
